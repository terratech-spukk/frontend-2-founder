  ...
  const [hotels] = useState([
    {
      ...
      "description": "โรงแรมหรู 5 ดาวใจกลางกรุงเทพฯ ใกล้ BTS ชิดลม พร้อมสิ่งอำนวยความสะดวกครบครัน",
      "amenities": [
        "WiFi ฟรี",
        "สระว่ายน้ำ",
        "ฟิตเนส",
    ...
    },
    {
      ...
      "description": "วิลล่าส่วนตัวริมทะเลชะอำ พร้อมสระว่ายน้ำส่วนตัว เหมาะสำหรับครอบครัว",
      "amenities": [
        "WiFi ฟรี",
        "สระว่ายน้ำส่วนตัว",
        "ครัวส่วนตัว",
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">รายการโรงแรมและที่พัก</h1>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {hotels.map((hotel) => (
                  <tr key={hotel.id} className="hover:bg-gray-50 transition-colors duration-150">
