...
export function IncomeAnalytics({ onError }: IncomeAnalyticsProps) {
    ...
    const calculateTotalStats = () => {
        ...
        const completedOrders = filteredOrders.filter(order => order.status === 'serve');
            ...
            <div className="px-6 py-4 border-b border-gray-200">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-gray-600 text-sm">Revenue trends and income from served orders</p>
                    </div>
                    <select
                        value={timeRange}
                                ...
                                <LineChart data={dailyRevenue}>
                                    ...
                                    <Tooltip 
                                        formatter={(value: number, name: string) => [
                                            `฿${value.toFixed(2)}`, 
                                            name === 'revenue' ? 'Revenue' : name === 'completedRevenue' ? 'Completed Revenue' : 'Orders'
                                        ]}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="text-center">
                            <div className="text-3xl font-bold text-blue-600 mb-2">
                                {stats.totalOrders > 0 ? (stats.completedRevenue / stats.totalRevenue * 100).toFixed(1) : 0}%
                            </div>
                            <p className="text-sm text-gray-600">Revenue Realized</p>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl font-bold text-purple-600 mb-2">
                                {stats.completedOrders > 0 ? (stats.completedRevenue / stats.completedOrders).toFixed(2) : 0}
                            </div>
