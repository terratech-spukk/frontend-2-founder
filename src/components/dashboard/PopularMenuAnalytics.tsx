        ...
        <div className="bg-white rounded-lg shadow-sm">
            <div className="px-6 py-4 border-b border-gray-200">
                <div className="flex items-center justify-between">
                    <div>
                        <h2 className="text-xl font-bold text-gray-900">Popular Menu Items</h2>
                        <p className="text-gray-600 text-sm">Most ordered food items and their performance</p>
                    </div>
                    <select
                        value={timeRange}
                ...
                {popularItems.length === 0 ? (
                    ...
                    <div className="space-y-4">
                        {popularItems.map((item, index) => {
                            ...
                            return (
                                <div key={item.menu_id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                                    <div className="flex items-center justify-between mb-3">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-gray-500">Menu ID: {item.menu_id}</p>
                                            </div>
                                        </div>
                ...
                {popularItems.length > 0 && (
                    <div className="mt-6 pt-6 border-t border-gray-200">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="text-center">
                                <p className="text-2xl font-bold text-gray-900">{popularItems.length}</p>
                            ...
                            <div className="text-center">
                                <p className="text-2xl font-bold text-gray-900">
                                    ฿{popularItems.reduce((sum, item) => sum + item.totalRevenue, 0).toFixed(2)}
                                </p>
